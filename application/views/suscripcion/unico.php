<div class="block">
    <div class="block-title">
        <h2><strong>Suscripcion Única : </strong><?php print($curso["nombre"]) ?></h2>
        <h3><?php print($curso["descripcion"]) ?></h3>
    </div>
	<div class="row">
	  	<div class="col-md-8">
		    <form id="wizardPlanAnual" method="POST" class="form-horizontal form-bordered">
		        <input type="hidden" id="id_curso" name="id_curso" value="<?php print($curso["id_curso"]) ?>">
	    ...
	    <div class="col-md-4">
	    	<a href="javascript:void(0)" class="widget widget-hover-effect3 themed-color-amethyst">
                <div class="widget-simple">
                    <img src="<?php print($curso["icono"]) ?>" class="widget-image img-circle pull-right">
                    <h4 class="widget-content">
                        <strong>S/. <?php print($curso["precio"]) ?></strong>
                        <small><?php print($curso["nombre"]) ?></small>
                    </h4>
                </div>
            </a>
	    	<h2>Beneficios</h2>
	    	<p><?php foreach ($curso["beneficios"] as $indice => $beneficio) { ?>
