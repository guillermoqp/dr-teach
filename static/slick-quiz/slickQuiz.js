    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                preventUnansweredText: 'Debes seleccionar por lo menos una respuesta.',
                questionTemplateText:  '%count. %text',
                scoreTemplateText: '%score / %total',
                nameTemplateText:  '<span>Examen: </span>%name',
            ...
            //AGREGADO PARA RETORNAR PUNTAJE
            _quizScore2            = _element + '#quizScore2',
        ...
        if (options && typeof options.disableNext != 'undefined') {
            ...
            depMsg += 'La \'disableNext\' opcion ha sido invalida, por favor usa \'preventUnanswered\' en este lugar.\n\n';
        }
        ...
        plugin.method = {
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableScore) {
                    ...
                    $(_quizScore2).val(displayScore);
                    $(_quizScore2).html(displayScore);
                }
            ...
            // METODO CREADO PARA OBTENER SCORE :
            obtenerScore: function() {
                var score        = $(_element + ' ' + _correct).length,
                    displayScore = score;
                if (plugin.config.scoreAsPercentage) {
                    displayScore = (score / questionCount).toFixed(2)*100 + "%";
